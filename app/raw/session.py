...
def set_record(results, session_id, cookie_id, individual_id, logic, intention, duration, active_duration, loading_duration):
    global INIT_R
    ...
    with gzip.open(filepath, "r", encoding="utf-8") as in_file:
        ...
        for line in in_file:
            if is_header:
                ...
                set_record(results, session_id, cookie_id, individual_id, logic, intention, duration, active_duration, loading_duration)
